...
like($druid->getContent, qr(.*dist/prototype.js.*prototype_extensions.js.*dist/effects.js.*dist/controls.js.*scriptaculous_extensions.js.*base.js.*druid.js.*?
...
<div (?:(?:iwl:druidCheckCallback="alert"|class="\1_page \1_page_selected"|iwl:druidCheckParam="\[%22this%22,%22%22\]"|iwl:druidFinalPage="1"|id="\1_page_\d+")\s*){5}><span id="label_\d+">Last page</span>
</div>
</div>
