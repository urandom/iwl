...
like($druid->getContent, qr(<div (?:(?:class="(druid)"|id="\1_\d+")\s*){2}><div (?:(?:class="\1_content"|id="\1_\d+_content")\s*){2}><div (?:(?:class="\1_page"|id="\1_page_\d+")\s*){2}><span id="label_\d+">First page</span>
</div>
...
<br style="clear: both" />
.*dist/prototype.js.*prototype_extensions.js.*dist/effects.js.*dist/controls.js.*scriptaculous_extensions.js.*base.js.*druid.js.*button.js.*?
