...
like($t->getContent, qr(<table (?:(?:class="(tree) iwl-unselectable"|id="(\1_\d+)"|cellspacing="0"|cellpadding="0"|unselectable="on")\s*){5}><thead (?:(?:class="\1_header"|id="\2_header")\s*){2}><tr (?:(?:iwl:treeRowData=".*?"|id="header1"|class="\1_row \1_header_row")\s*){3}></tr>
